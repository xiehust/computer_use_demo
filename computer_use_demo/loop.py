...
from bedrock_nova import BedrockNova
...
PROVIDER_TO_DEFAULT_MODEL_NAME: dict[APIProvider, str] = {
    ...
    APIProvider.BEDROCK_NOVA: "us.amazon.nova-pro-v1:0",
}
...
SYSTEM_PROMPT = f"""You are a computer agent, you can actually operate a vitural computer. 
you have capability:
<SYSTEM_CAPABILITY>
...
async def sampling_loop(
    *,
    ...
    while True:
        ...
        elif provider == APIProvider.BEDROCK_NOVA:
            client = BedrockNova()
        ...
        if not provider == APIProvider.BEDROCK_NOVA:
            ...
            try:
                response = client.invoke(
                    ...
                    messages=messages,
                    system=system,
                    tools=tool_collection.to_params_nova(),
                )
            except Exception as e:
                api_response_callback(messages, '', e)
                return messages
