...
def setup_state():
    ...
    if "provider" not in st.session_state:
        st.session_state.provider = (
            os.getenv("API_PROVIDER", "anthropic") or APIProvider.BEDROCK_NOVA
        )
...
async def main():
    ...
    with st.sidebar:
        ...
        provider_options = [option.value for option in APIProvider][1:]
        st.radio(
            "API Provider",
    ...
    chat, http_logs = st.tabs(["Chat", "Message Logs"])
